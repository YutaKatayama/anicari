    ...
    >
      <div className="relative z-20 flex justify-end px-5 md:px-0">
        <ScrollReveal variant="fade-up" className="w-full md:w-auto">
          <div
            id="about"
            className="branding-mission -mt-14 w-full max-w-full rounded-tl-[0.6rem] rounded-bl-[0.6rem] bg-surface px-5 py-6 text-brand shadow-[0_8px_32px_rgba(168,148,148,0.18)] sm:-mt-16 sm:px-[6%] sm:py-[7%] md:-mt-24 md:w-[60vw] md:max-w-[720px] md:px-[5%] md:py-[2.4%]"
          >
      ...
      <div className="relative z-0 bg-section pb-12 pt-6 sm:pb-15 sm:pt-8 md:pt-12">
